...
Usage: quartet AssemblyMapper <parameters>
  ...
  --teclade {plant,animal,other}
                        Specify clade of this genome for telomere search. Plant will search TTTAGGG, animal will search TTAGGG, other will use tidk
                        explore's suggestion, default: other
  --teminrepeattimes TE_MIN_REPEAT_TIMES
                        The min repeat times to considered as telomere, default: 100
  --notelo              Skip telomere-assisted ordering and orientation.
```
